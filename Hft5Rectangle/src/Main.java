//ınherıtance uygulaması

//ŞÜKÜR BİTTİ NOTLARA EKLDİM
...
class GeoObj {
    ...
    public Date getDate() {
        return dateCreated;
    } //setDate koymuyoz hocam onu yapamıyoz
...
kullanalım. Ha yine constructorumuza width ve height ekleyecez burda. Ama en azından color ve filledin eklenmesiyle uğraşmayak bidaha**/
    ...
    /**
    HADİ ŞU toString() metodunda ovirride anlatalım(overload yapamayız çünkü parametresi yok aq)
    ----------------------------------------------------------------------------
    @Override
    public String toString(){
    ...
    -----------------------------------------------------------------------------
    ovirride ederiz bu şekilde. ama dikkat ettiysen ana classtayken fonksiyonumuz GeoObj bilgilerini
    gösteriyodu o bilgileri görcek şekilde ovirride da edebiliriz!!
    --------------------------------------------------------------------------------------
     **/
    @Override
